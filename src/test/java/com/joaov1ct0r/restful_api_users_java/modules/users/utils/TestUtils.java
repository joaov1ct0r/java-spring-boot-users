...
public class TestUtils {
    public static MockMultipartFile stringToMMF(UserEntity user) {
        String jsonData = String.format("{\"name\":\"%s\", \"email\":\"%s\", \"username\": \"%s\", \"password\": \"%s\", \"id\": \"%s\", \"photoUrl\": \"%s\", \"createdAt\": \"%s\", \"updatedAt\": \"%s\", \"userWhoUpdatedId\": \"%s\"}", user.getName(), user.getEmail(), user.getUsername(), user.getPassword(), user.getId(), user.getPhotoUrl(), user.getCreatedAt(), user.getUpdatedAt(), user.getUserWhoUpdatedId());
